...
class Mage_Customer_AccountController extends Mage_Core_Controller_Front_Action
{
    ...
    public function loginAction()
    {
        ...
        if(!empty($this->getRequest()->getParam('local'))){
            Mage::getSingleton('core/session')->setOrigem('carrinho');
        }else{
            Mage::getSingleton('core/session')->setOrigem('categorias');
        }
    ...
    protected function _loginPostRedirect()
    {
        ...
        $carrinhoSession = Mage::getSingleton('core/session')->getOrigem('carrinho');
        if($session->isLoggedIn() && $carrinhoSession == 'carrinho'){
    ...
    protected function _successProcessRegistration(Mage_Customer_Model_Customer $customer)
    {
        ...
        if ($customer->isConfirmationRequired()) {
            ...
            $carrinhoSession = Mage::getSingleton('core/session')->getOrigem('carrinho');
            if($session->isLoggedIn() && $carrinhoSession == 'carrinho'){
                $this->_getSession()->setBeforeAuthUrl(Mage::getBaseUrl() . 'oscheckout');
            }
        ...
        //$this->_forceRedirect($url, $this);
        $this->_redirect('oscheckout');
