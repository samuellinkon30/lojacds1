...
/**
 * Category of sizes model
 *
 * @category    Ave
 * @package     Ave_SizeChart
 * @author      averun <dev@averun.com>
 */
class Ave_SizeChart_Model_Category extends Mage_Catalog_Model_Abstract
{
    /**
     * Entity code.
     * Can be used as part of method name for entity processing
     */
    const ENTITY    = 'ave_sizechart_category';
    const CACHE_TAG = 'ave_sizechart_category';
     ...
     * @var string
     */
    protected $_eventPrefix = 'ave_sizechart_category';
        ...
        if (!$this->hasData('_chart_collection')) {
            if (!$this->getId()) {
                ...
                $collection = Mage::getResourceModel('ave_sizechart/chart_collection')->addAttributeToSelect('*')
                        ->addAttributeToFilter('category_id', $this->getId());
