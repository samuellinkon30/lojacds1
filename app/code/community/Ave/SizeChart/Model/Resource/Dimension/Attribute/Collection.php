...
/**
 * Dimension attribute collection model
 *
 * @category    Ave
 * @package     Ave_SizeChart
 * @author      averun <dev@averun.com>
 */
class Ave_SizeChart_Model_Resource_Dimension_Attribute_Collection
    extends Mage_Eav_Model_Resource_Entity_Attribute_Collection
{
     ...
     *
     * @access protected
     * @return Ave_SizeChart_Model_Resource_Dimension_Attribute_Collection
     * @author averun <dev@averun.com>
     */
    protected function _initSelect()
    {
        $this->getSelect()->from(array('main_table' => $this->getResource()->getMainTable()))
            ->where(
                ...
                Mage::getModel('eav/entity')->setType('ave_sizechart_dimension')->getTypeId()
            )
            ->join(
