 ...
 */
abstract class Ave_SizeChart_Helper_Image_Abstract extends Mage_Core_Helper_Data
{
    /**
     ...
     * @return Ave_SizeChart_Helper_Image_Abstract
     * @author averun <dev@averun.com>
     */
     ...
     * @access public
     * @param bool $value
     * @return mixed(bool|Ave_SizeChart_Helper_Image_Abstract)
     * @author averun <dev@averun.com>
     */
    ...
    protected function _getDestinationPath()
    {
        ...
        if ($this->_scheduledResize) {
            return $this->getImageBaseDir() . DS . $this->_resizeFolderName . DS . $this->_getDestinationImagePrefix()
                   . DS . $this->_image;
        } else {
    ...
    protected function _getImageUrl()
    {
        ...
        if ($this->_scheduledResize) {
            return $this->getImageBaseUrl() . '/' . $this->_resizeFolderName . '/' . $this->_getDestinationImagePrefix()
                   . $this->_image;
        } else {
    ...
    public function __toString()
    {
        try {
            ...
            if (!$io->fileExists($imageRealPath)) {
                $this->_doResize();
