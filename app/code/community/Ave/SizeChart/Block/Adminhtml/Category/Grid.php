...
/**
 * Category of sizes admin grid block
 *
 * @category    Ave
 * @package     Ave_SizeChart
 * @author      averun <dev@averun.com>
 */
class Ave_SizeChart_Block_Adminhtml_Category_Grid extends Mage_Adminhtml_Block_Widget_Grid
{
    /**
     * constructor
     *
     ...
     *
     * @access protected
     * @return Ave_SizeChart_Block_Adminhtml_Category_Grid
     * @author averun <dev@averun.com>
     */
    protected function _prepareCollection()
    {
        $collection = Mage::getModel('ave_sizechart/category')
            ->getCollection()
        ...
        if ($this->_getStore()->getId()) {
            $this->addColumn(
                ...
                array(
                    ...
                    'align'     => 'left',
                    'index'     => 'ave_sizechart_category_name',
                )
            );
        }
     ...
     *
     * @access public
     * @param Ave_SizeChart_Model_Category
     * @return string
     * @author averun <dev@averun.com>
     */
