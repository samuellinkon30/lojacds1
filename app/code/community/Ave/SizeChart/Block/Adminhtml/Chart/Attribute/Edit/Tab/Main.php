...
/**
 * Adminhtml chart attribute edit page main tab
 *
 * @category    Ave
 * @package     Ave_SizeChart
 * @author      averun <dev@averun.com>
 */
class Ave_SizeChart_Block_Adminhtml_Chart_Attribute_Edit_Tab_Main
    extends Mage_Eav_Block_Adminhtml_Attribute_Edit_Main_Abstract
{
     ...
     *
     * @access protected
     * @return Ave_SizeChart_Block_Adminhtml_Chart_Attribute_Edit_Tab_Main
     * @author averun <dev@averun.com>
     */
    protected function _prepareForm()
    {
        ...
        Mage::dispatchEvent('adminhtml_chart_attribute_types', array('response'=>$response));
        ...
        Mage::dispatchEvent(
            'ave_sizechart_adminhtml_chart_attribute_edit_prepare_form',
            array(
                'form'      => $form,
