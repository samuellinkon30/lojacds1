...
class Codazon_Flexibletheme_Block_Adminhtml_System_Config_Switcher extends Mage_Adminhtml_Block_Template
{
    ...
    public function getStoreSelectOptions()
    {
        ...
        $options['default'] = array(
            ...
            'url'      => $url->getUrl('*/*/*', array('section'=>$section, 'theme_id' => $themeId)),
                ...
                foreach ($storeModel->getStoreCollection() as $store) {
                    ...
                    if (!$websiteShow) {
                        ...
                        $options['website_' . $website->getCode()] = array(
                            ...
                            'url'      => $url->getUrl('*/*/*', array('section'=>$section, 'website'=>$website->getCode(), 'theme_id' => $themeId)),
                    ...
                    $options['store_' . $store->getCode()] = array(
                        'label'    => $store->getName(),
                        'url'      => $url->getUrl('*/*/*', array('section'=>$section, 'website'=>$website->getCode(), 'store'=>$store->getCode(), 'theme_id' => $themeId)),
