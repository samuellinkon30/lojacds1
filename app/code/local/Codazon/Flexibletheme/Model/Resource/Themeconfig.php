 ...
 */
class Codazon_Flexibletheme_Model_Resource_Themeconfig extends Mage_Core_Model_Resource_Db_Abstract
{
    /**
     * Define main table
     *
     ...
     */
    public function loadToXml(Codazon_Flexibletheme_Model_Themeconfig $xmlConfig, $condition = null)
    {
        ...
        $select = $read->select()
            ->from($this->getMainTable(), array('scope', 'scope_id', 'path', 'theme_id', 'value'));
     ...
     * @return Mage_Core_Model_Resource_Config
     */
    public function deleteConfig($themeId, $path, $scope, $scopeId)
    {
        ...
        $adapter->delete($this->getMainTable(), array(
            ...
            $adapter->quoteInto('theme_id = ?', $themeId)
        ));
        return $this;
    }
}
