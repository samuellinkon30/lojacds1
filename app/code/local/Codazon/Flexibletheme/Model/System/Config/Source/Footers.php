...
class Codazon_Flexibletheme_Model_System_Config_Source_Footers
{   
    ...
    {
        $collection = Mage::getModel('flexibletheme/footer')->getCollection()
            ->addAttributeToSelect(['title']);
        $options = array(
            array('value' => '', 'label' => __('-- Select Footer --'))
        );
        if ($collection->count()) {
