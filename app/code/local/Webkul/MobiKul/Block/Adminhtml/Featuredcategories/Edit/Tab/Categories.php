<?php
    ...
    class Webkul_MobiKul_Block_Adminhtml_Featuredcategories_Edit_Tab_Categories extends Mage_Adminhtml_Block_Catalog_Category_Tree{
        ...
        protected function getCategoryIds()	    {
            if($this->getRequest()->getParam("id") > 0)
                return array(Mage::getModel("mobikul/featuredcategories")->load($this->getRequest()->getParam("id"))->getCategoryId());
            else
                return array();
        }
