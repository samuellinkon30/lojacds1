<?php
    ...
    class Webkul_MobiKul_Block_Adminhtml_Categoryimages_Edit_Tab_Categories extends Webkul_MobiKul_Block_Adminhtml_Catalog_Category_Tree	{
        ...
        public function __construct() {
            parent::__construct();
            $this->setTemplate("mobikul/categories.phtml");
        }
        ...
        protected function getCategoryIds()	    {
            if($this->getRequest()->getParam("id") > 0)
                return array(Mage::getModel("mobikul/categoryimages")->load($this->getRequest()->getParam("id"))->getCategoryId());
            else
                return array();
        }
