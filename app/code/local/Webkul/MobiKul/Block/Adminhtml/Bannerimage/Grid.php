<?php
    ...
    class Webkul_MobiKul_Block_Adminhtml_Bannerimage_Grid extends Webkul_MobiKul_Block_Adminhtml_Widget_Grid {
        ...
        protected function _prepareCollection() {
            $collection = Mage::getModel("mobikul/bannerimage")->getCollection();
