 ...
 */
class LA_Postcode_Block_Adminhtml_Postcode_Edit extends Mage_Adminhtml_Block_Widget_Form_Container
{
    ...
    public function getHeaderText()
    {
        if (Mage::registry('postcode_data')
            && Mage::registry('postcode_data')->getId()
        ) {
            return Mage::helper('postcode')->__("Edit Item '%s'",
                                                $this->htmlEscape(Mage::registry('postcode_data')->getTitle())
            );
        }
