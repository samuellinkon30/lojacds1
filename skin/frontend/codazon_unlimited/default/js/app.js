...
$j(document).ready(function () {
    ...
    mageToggleElements();
    $j('body').on('productlistUpdated', function() {
        mageToggleElements();
    });
...
var ProductMediaManager = {
    ...
    wireThumbnails: function() {
        ...
        $j('.product-image-thumbs .thumb-link').on('click touchstart', function(e) {
            e.preventDefault();
            var jlink = $j(this);
...
jQuery('dd.odd:nth-child(2) > ol > li > a').removeClass('swatch-link');
jQuery('dd.odd:nth-child(2) > ol > li > a > span').removeClass('swatch-label');
});
